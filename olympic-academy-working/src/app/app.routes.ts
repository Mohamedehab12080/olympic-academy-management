...
export const routes: Routes = [
  ...
  { 
    path: 'auth/activate', 
    loadComponent: () => import('./core/auth/pages/activate-account/activate-account.component')
  ...
  { 
    path: 'register', 
    loadComponent: () => import('./core/auth/pages/register/register.component')
      .then(m => m.RegisterComponent) 
  },
  { 
    path: 'forgot-password', 
    loadComponent: () => import('./core/auth/pages/forgot-password/forgot-password.component')
