...
public class TraineeContactVTO implements Serializable {
    ...
    public TraineeContactVTO id(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public TraineeContactVTO contactValue(String contactValue) {
    ...
    public boolean equals(Object o) {
        ...
        TraineeContactVTO traineeContactVTO = (TraineeContactVTO) o;
        return Objects.equals(this.id, traineeContactVTO.id)
                && Objects.equals(this.contactType, traineeContactVTO.contactType)
                && Objects.equals(this.contactValue, traineeContactVTO.contactValue);
    }
    ...
    public String toString() {
        ...
        sb.append("class TraineeContactVTO {\n");
